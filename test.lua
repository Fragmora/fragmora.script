...
local function getClosestTargetAimbot()
    ...
    for _, plr in pairs(Players:GetPlayers()) do
        if plr ~= LocalPlayer and plr.Character then
            ...
            -- Ignoriere Team-Mitglieder
            if ignoreTeamAimbot and plr.Team == LocalPlayer.Team then
                continue
            end
            
            -- Ignoriere untouchable Teams
            if ignoreUntouchableAimbot and plr.Team then
                local teamName = plr.Team.Name:lower()
                if teamName:find("admin") or teamName:find("spectator") then
                    continue
                end
            ...
            if ignoreNotWanted and plr.Team and plr.Team.Name:lower():find("civilian") then
