...
local function ShowHitMarker(isHeadshot, damage, isKill)
    ...
    local color = isHeadshot and HitMarkerSettings.Color or HitMarkerSettings.Color
...
local function vu401()
    ...
    local v400 = LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid")
    return not v400 and true or v400.Health < 30
end

local function vu407()
    local v402 = workspace:FindFirstChild("Vehicles")
    if v402 then
        v402 = workspace.Vehicles:FindFirstChild(LocalPlayer.Name)
    end
    local v403 = LocalPlayer.Character
    if v402 and v403 then
        local v404 = v403:FindFirstChildWhichIsA("Humanoid")
        local v405 = v403:FindFirstChild("HumanoidRootPart")
        local v406 = v402:FindFirstChild("DriveSeat")
...
local function vu410()
    local v408 = LocalPlayer.Character
    if v408 then
        local v409 = v408:FindFirstChildWhichIsA("Humanoid")
        if v409 then
            v409.Sit = false
        end
    end
...
local function vu415()
    local v411 = workspace.Buildings and (workspace.Buildings:FindFirstChild("Hospital") and workspace.Buildings.Hospital:FindFirstChild("HospitalBed"))
    if v411 then
        v411 = workspace.Buildings.Hospital.HospitalBed:FindFirstChild("Seat")
    end
    local v412 = LocalPlayer.Character
    if v411 and v412 then
        local v413 = v412:FindFirstChildWhichIsA("Humanoid")
        local v414 = v412:FindFirstChild("HumanoidRootPart")
...
local function selfReviveSequence()
    if vu401() then
        local v416 = LocalPlayer.Character
        if not v416 then
            return
        end
        local v417 = v416:FindFirstChildWhichIsA("Humanoid")
        local v418 = v416:FindFirstChild("HumanoidRootPart")
        if not (v417 and v418) then
            return
        end
        local v419 = workspace:FindFirstChild("Vehicles")
        if v419 then
...
local copyFullOutfit = function(player)
