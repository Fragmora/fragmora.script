-- main.lua - Komplette All-in-One Version
return function(Window, tabs, services)
    -- ========== GLOBALE VARIABLEN ==========
    local Players = services.Players
    local RunService = services.RunService
    local LocalPlayer = services.LocalPlayer
    local task_wait = services.task_wait
    local task_spawn = services.task_spawn
    ...
    tab8:Button({
        ...
        Callback = function()
            ...
            Window:Notify({ Title = "Discord", Content = "Discord link copied!", Duration = 2 })
        end
    })
